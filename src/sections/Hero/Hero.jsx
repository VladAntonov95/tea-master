...
const Hero = () => {
  return (
    <section className="mx-auto max-w-[1024px] flex justify-between mt-10">
      <article className="self-center w-[580px] pr-5">
        <h1 className="text-4xl text-left mb-5 font-CrimsonPro">
        ...
        <p className="text-md font-Roboto mt-5">
