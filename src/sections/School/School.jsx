    ...
    <section className="mx-auto max-w-[1024px] my-20">
      ...
      <div className="border-wood border mt-8 p-4 rounded-lg flex flex-col">
        <p className="text-md font-Roboto">
          В чайній школі &quot;Пересвітм, де проходять навчання, бажаючі
          отримати унікальні знання, дізнатись тонкощі та особливості чайної
          справи, використовувати чаї в укріпленні свого організму, і звісно ж
          дивувати своїх друзів та рідних смачними чаями та приємними емоціями,
          і можливо, стати справжнім чайним майстром! Чайна традиція «Пересвіт»
          не оминула і наше молоде покоління! Для дітей та підлітків створено
